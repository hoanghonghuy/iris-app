...
function parseHttpAction(action: string): { method: string; path: string } | null {
...
function getFriendlyHttpAction(method: string, path: string, entityType: any): string {
  if (
...
function getEventEntityLabel(prefix: string): string {
...
function getFriendlyEventAction(action: string): string {
...
function formatQueryValue(query: any): string {
  if (!query) {
    return ''
  }
...
function formatStatusLine(status: any): string {
...
export function getAuditActorLabel(log: any): string {
...
export function getAuditFriendlyAction(log: any): string {
...
export function getAuditActionTone(log: any): string {
...
export function getAuditEntitySummary(log: any): string {
  const label = getEntityLabel(log?.entity_type)
  return label
}

export function getAuditDetailLines(log: any): string[] {
